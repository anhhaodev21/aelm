...
def print_info_banner():
    banner = (        
        ...
        "\033[1;33m ➜ \033[1;39m[3] Nhây Top image mess\n"
        "\033[1;39m└─────────────────────────────────────────────────────┘\n"
    )
    print(banner)
...
a = " \033[1;97m[\033[1;31mThang\033[1;97m] => "
...
def visual_delay(t):
    ...
    while time.time() - start_time < t:
        ...
        for step in ["LOADING ", "LOADING.", "LOADING..", "LOADING..."]:
            print(f"\r\033[1;31m[\033[1;33mZRF\033[1;31m] \033[1;92m ~> {step} \033[0;31m | {remaining_time} | \r", end='')
            time.sleep(0.00025)
    print("\r\033[1;95m    Done. \033[1;97m                         \r", end='')

# Phần còn lại giữ nguyên như bạn đã gửi (check_login_facebook, get_token, auto_cmt_moi_ne...)
...
def main():
    ...
    links, link_count = get_random_line_and_count_from_file(file_path_link, "Không có link ảnh nào trong tệp.")
    ...
    print(f"{a}\033[1;92mSố lượng link ảnh đã tải: \033[1;33m{link_count}")
            ...
            if comment_text is not None:
                ...
                if access_token:
                    ...
                    if response == "1":
                        ...
                        print(f"[{i+1}] {COLORS['luc']}Comment Ảnh {COLORS['do']}| {COLORS['vang']}{response.get('id')} {COLORS['do']}| {COLORS['hong']}{noidung} | {COLORS['xnhac']}Thành Công")
                ...
                print("\033[1;31mKhông thể phân tích bình luận hoặc URL hình ảnh không hợp lệ.")
        except Exception as e:
